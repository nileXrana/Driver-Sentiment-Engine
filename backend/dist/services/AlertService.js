...
class AlertService {
    constructor(alertRepository, driverRepository, alertThreshold = 2.5, cooldownSeconds = 3600) {
        this.alertRepository = alertRepository;
        this.driverRepository = driverRepository;
        this.alertThreshold = alertThreshold;
        this.cooldownSeconds = cooldownSeconds;
        console.log(`[AlertService] Initialized — threshold: ${this.alertThreshold}, ` +
     ...
     */
    async checkAndAlert(driverId, currentScore) {
        try {
            ...
            if (isOnCooldown) {
                console.log(`[AlertService] Skipping alert for driver '${driverId}' — ` +
            ...
            console.warn(`[AlertService] ⚠ ALERT CREATED for driver '${driverId}': ` +
     ...
     */
    async isDriverOnAlertCooldown(driverId) {
